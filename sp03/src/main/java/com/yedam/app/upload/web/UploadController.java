...
public class UploadController {
	...
	public String formUploadFile(@RequestPart MultipartFile file) {
		...
		log.info("[종류 및 확장자]	" + file.getContentType()); // 파일의 종류 및 확장자
		log.info("[파일 이름]	" + file.getOriginalFilename()); // 파일 이름
		log.info("[파일 크기]	" + String.valueOf(file.getSize())); // 파일 크기

		String fileName = file.getOriginalFilename();
		String saveName = uploadPath + File.separator + fileName;
		log.debug("[경로 및 이름]	" + "[" + uploadPath + "] [" + File.separator + "] [" + fileName + "]");
